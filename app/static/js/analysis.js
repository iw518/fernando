class SvgContainer {
    ...
    creatAxis(yTitle = "Y Title") {
        //定义marker
        var defs = this.svgDoc.createElementNS(this.svgns, "defs");
        var marker = this.svgDoc.createElementNS(this.svgns, "marker");
        ...
        var path = this.svgDoc.createElementNS(this.svgns, "path");
        path.setAttribute("stroke", "none");
        path.setAttribute("fill", "red");
        var d = "M 0 0 12 4 0 8 Z";
